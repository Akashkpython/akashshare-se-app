/**
 * Fixed Electron Builder Configuration for Akash Share Setup.exe
 * Resolves CORS, binding, and WebSocket issues
 */
...
module.exports = {
  ...
  // NSIS installer configuration - Fixed for reliability
  nsis: {
    // Basic settings
    oneClick: false,
    perMachine: false,
  ...
  afterPack: async (context) => {
    ...
    console.log('🔗 Server binding issues resolved');
  }
};
