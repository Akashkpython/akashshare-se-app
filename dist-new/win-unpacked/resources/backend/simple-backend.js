...
app.post('/upload', (req, res) => {
  console.log('✅ Upload endpoint received');
  res.json({ 
...
app.get('/api/status', (req, res) => {
  console.log('✅ API status endpoint received');
  res.json({ 
    status: 'OK',
...
app.get('*', (req, res) => {
  // Skip API routes
  if (req.path.startsWith('/api/') || req.path.startsWith('/status') || req.path.startsWith('/health') || req.path.startsWith('/test') || req.path.startsWith('/upload')) {
