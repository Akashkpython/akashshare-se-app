...
/**
 * Unified Electron startup script for Akash Share
 * Starts backend server and then launches Electron app
 */
...
console.log('🚀 Starting Akash Share Electron Application...');
...
}, 5000); // Wait 5 seconds for backend to fully start
