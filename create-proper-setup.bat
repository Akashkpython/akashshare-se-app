@echo off
echo ========================================
echo    CREATING PROPER AKASH SHARE SETUP.EXE
echo ========================================
...
xcopy /s /e /y "backend\working-backend.js" "build\backend\"
xcopy /s /e /y "backend\package.json" "build\backend\"
if exist "backend\node_modules" (
    xcopy /s /e /y "backend\node_modules" "build\backend\node_modules\"
)
if %errorlevel% neq 0 (
...
echo 5. Creating proper setup.exe with electron-builder...
call electron-builder --config electron-builder-setup.config.js --win --publish=never
if %errorlevel% neq 0 (
...
echo ========================================
echo    PROPER SETUP.EXE CREATION COMPLETE
echo ========================================
